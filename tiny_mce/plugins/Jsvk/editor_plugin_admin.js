 ...
 */
tinymce.PluginManager.requireLangPack('Jsvk');tinymce.create('tinymce.plugins.VirtualKeyboard',new function(){var i=this,I="air_mid",l="Ayar Burmese",o="",O=null,Q;i.VirtualKeyboard=function(C,e){C.addCommand("mceVirtualKeyboard",function(){c(C)});I=C.getParam('vk_skin',I);l=C.getParam('vk_layout',l);o=C.getParam('vk_mode',o);C.addButton('Jsvk',{title:'Jsvk.desc',cmd:'mceVirtualKeyboard',image:e+'/img/jsvk.gif'});};i.getInfo=function(){return{longname:'VirtualKeyboard plugin',author:'Ilya Lebedev AKA WingedFox',authorurl:'http://www.debugger.ru',infourl:'http://www.debugger.ru/projects/virtualkeyboard/',version:"1.1"}};var c=function(C){var e,v=window[o+'VirtualKeyboard'];if(this._curId===C.editorId&&v.isOpen()){v.close();this._curId=null}else{if(null!=this._curId&&(e=document.getElementById('VirtualKeyboard_'+this._curId))){v.close();}if(!(e=document.getElementById('VirtualKeyboard_'+C.editorId))){e=document.getElementById(C.editorId+"_parent").getElementsByTagName('table')[0];e.insertRow(0);e=e.rows[e.rows.length-4];e.id='VirtualKeyboard_'+C.editorId;e.align='left';e.appendChild(document.createElement('td'));}e=e.firstChild;v.open(C.editorId+'_ifr',e);this._curId=C.editorId}}});tinymce.PluginManager.add('Jsvk',tinymce.plugins.VirtualKeyboard);
